...
#define BTP_SERVICE_ID_RFCOMM	32
#define BTP_SERVICE_ID_BPS	33
#define BTP_SERVICE_ID_WSS	34
#define BTP_SERVICE_ID_SPS	35

#define BTP_SERVICE_ID_MAX	BTP_SERVICE_ID_SPS
